...
namespace ASW.APIServices.Core.Test
{
    ...
    /// </remarks>
    public class DutiesApiTests : IDisposable
    {
        private DutiesApi instance;

        public DutiesApiTests()
        {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOfType' DutiesApi
            //Assert.IsType(typeof(DutiesApi), instance, "instance is a DutiesApi");
        }
