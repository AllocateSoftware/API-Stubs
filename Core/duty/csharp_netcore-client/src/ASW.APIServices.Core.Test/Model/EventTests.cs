...
namespace ASW.APIServices.Core.Test
{
    ...
    public class EventTests : IDisposable
    {
        ...
        public void DutyDeletedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyDeletedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentTimesheetRejectedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentTimesheetRejectedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentUpdatedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentUpdatedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentClearedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentClearedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentTimesheetConfirmedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentTimesheetConfirmedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyUpdatedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyUpdatedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentTimesheetUnconfirmedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentTimesheetUnconfirmedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentSubmittedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentSubmittedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyTempStaffingNoteDeletedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyTempStaffingNoteDeletedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentFinalisedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentFinalisedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyCancelledEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyCancelledEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyTempStaffingNoteCreatedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyTempStaffingNoteCreatedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyApprovedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyApprovedEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyCascadeEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyCascadeEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentRedeploymentEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentRedeploymentEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyTempStaffingExpressionOfInterestEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyTempStaffingExpressionOfInterestEvent().ToJson()));
        }
        /// <summary>
        ...
        public void DutyAssignmentUnFinalisedEventDeserializeFromEventTest()
        {
            ...
            //Assert.IsInstanceOf<Event>(JsonConvert.DeserializeObject<Event>(new DutyAssignmentUnFinalisedEvent().ToJson()));
        }
