...
namespace ASW.APIServices.Core.Api
{
    ...
    public partial class BookingsApi : IBookingsApi
    {
        ...
        /// <returns></returns>
        public BookingsApi(ASW.APIServices.Core.Client.Configuration configuration)
        {
        ...
        public BookingsApi(ASW.APIServices.Core.Client.ISynchronousClient client,ASW.APIServices.Core.Client.IAsynchronousClient asyncClient, ASW.APIServices.Core.Client.IReadableConfiguration configuration)
        {
        ...
        public ASW.APIServices.Core.Client.ApiResponse<Object> SendDutyCostingWithHttpInfo (string id, DutyCostDetails dutyCostDetails)
        {
            ...
            if (id == null)
                throw new ASW.APIServices.Core.Client.ApiException(400, "Missing required parameter 'id' when calling BookingsApi->SendDutyCosting");

            // verify the required parameter 'dutyCostDetails' is set
            if (dutyCostDetails == null)
                throw new ASW.APIServices.Core.Client.ApiException(400, "Missing required parameter 'dutyCostDetails' when calling BookingsApi->SendDutyCosting");
