...
namespace ASW.APIServices.Core.Api
{
    ...
    /// </summary>
    public interface IDutiesApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDutiesApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IDutiesApi : IDutiesApiSync, IDutiesApiAsync
    {
    ...
    public partial class DutiesApi : IDutiesApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public DutiesApi() : this((string) null)
        {
        }
        ...
        /// <returns></returns>
        public DutiesApi(ASW.APIServices.Core.Client.Configuration configuration)
        {
        ...
        public DutiesApi(ASW.APIServices.Core.Client.ISynchronousClient client,ASW.APIServices.Core.Client.IAsynchronousClient asyncClient, ASW.APIServices.Core.Client.IReadableConfiguration configuration)
        {
        ...
        public ASW.APIServices.Core.Client.ApiResponse<Object> CancelDutyWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ASW.APIServices.Core.Client.ApiException(400, "Missing required parameter 'id' when calling DutiesApi->CancelDuty");
        ...
        public ASW.APIServices.Core.Client.ApiResponse<Object> CancelDutyBookingWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ASW.APIServices.Core.Client.ApiException(400, "Missing required parameter 'id' when calling DutiesApi->CancelDutyBooking");
        ...
        public ASW.APIServices.Core.Client.ApiResponse<Object> SendDutyForFulfillmentWithHttpInfo (string id, string destination)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ASW.APIServices.Core.Client.ApiException(400, "Missing required parameter 'id' when calling DutiesApi->SendDutyForFulfillment");

            // verify the required parameter 'destination' is set
            if (destination == null)
                throw new ASW.APIServices.Core.Client.ApiException(400, "Missing required parameter 'destination' when calling DutiesApi->SendDutyForFulfillment");
