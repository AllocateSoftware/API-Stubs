...
namespace ASW.APIServices.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DutyAssignmentRedeploymentEventAllOf :  IEquatable<DutyAssignmentRedeploymentEventAllOf>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as DutyAssignmentRedeploymentEventAllOf);
        }

        /// <summary>
        /// Returns true if DutyAssignmentRedeploymentEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DutyAssignmentRedeploymentEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DutyAssignmentRedeploymentEventAllOf input)
        {
            if (input == null)
                return false;
