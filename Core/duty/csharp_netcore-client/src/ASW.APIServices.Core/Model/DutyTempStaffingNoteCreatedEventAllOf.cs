...
namespace ASW.APIServices.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DutyTempStaffingNoteCreatedEventAllOf :  IEquatable<DutyTempStaffingNoteCreatedEventAllOf>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DutyTempStaffingNoteCreatedEventAllOf" /> class.
        /// </summary>
        ...
        public DutyTempStaffingNoteCreatedEventAllOf(string dutyId = default(string), string noteId = default(string), string content = default(string))
        {
            this.DutyId = dutyId;
            this.NoteId = noteId;
        ...
        {
            return this.Equals(input as DutyTempStaffingNoteCreatedEventAllOf);
        }

        /// <summary>
        /// Returns true if DutyTempStaffingNoteCreatedEventAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of DutyTempStaffingNoteCreatedEventAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DutyTempStaffingNoteCreatedEventAllOf input)
        {
            if (input == null)
                return false;
