...
class DutyCascadeEvent(Model):
    ...
    def __init__(self, event_type: str=None, duty_id: str=None, cascade_from: str=None, cascade_to: str=None, is_duty_reset: bool=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'DutyCascadeEvent':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The DutyCascadeEvent of this DutyCascadeEvent.
        """
