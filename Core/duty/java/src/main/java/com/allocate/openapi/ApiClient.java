...
public class ApiClient {
    ...
    private String basePath = "http://healthsuite.allocatesoftware.com/api/duty/v1";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://healthsuite.allocatesoftware.com/api/duty/v1
