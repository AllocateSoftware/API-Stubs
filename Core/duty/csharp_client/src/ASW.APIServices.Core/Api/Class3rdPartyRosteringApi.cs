...
namespace ASW.APIServices.Core.Api
{
    ...
    /// </summary>
    public interface IClass3rdPartyRosteringApi : IApiAccessor
    {
    ...
    public partial class Class3rdPartyRosteringApi : IClass3rdPartyRosteringApi
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Class3rdPartyRosteringApi()
        {
        ...
        /// <returns></returns>
        public Class3rdPartyRosteringApi(ASW.APIServices.Core.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> CancelDutyWithHttpInfo (string id)
        {
            ...
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Class3rdPartyRosteringApi->CancelDuty");
        ...
        public ApiResponse<Object> CancelDutyBookingWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Class3rdPartyRosteringApi->CancelDutyBooking");
        ...
        public ApiResponse<string> CreateDutyWithHttpInfo (DutyDetails dutyDetails)
        {
            ...
            if (dutyDetails == null)
                throw new ApiException(400, "Missing required parameter 'dutyDetails' when calling Class3rdPartyRosteringApi->CreateDuty");
        ...
        public ApiResponse<Object> SendDutyForFulfillmentWithHttpInfo (string id, string destination)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling Class3rdPartyRosteringApi->SendDutyForFulfillment");
            // verify the required parameter 'destination' is set
            if (destination == null)
                throw new ApiException(400, "Missing required parameter 'destination' when calling Class3rdPartyRosteringApi->SendDutyForFulfillment");
