...
class DutyAssignmentTimesheetConfirmedEvent(object):
    ...
    @property
    def duty_id(self):
        """Gets the duty_id of this DutyAssignmentTimesheetConfirmedEvent.  # noqa: E501


        :return: The duty_id of this DutyAssignmentTimesheetConfirmedEvent.  # noqa: E501
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DutyAssignmentTimesheetConfirmedEvent):
            return False
