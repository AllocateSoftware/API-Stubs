...
class EmploymentDetails(Model):
    ...
    def __init__(self, employment_status: str=None, employee_type: str=None, hire_details: str=None, date_joined_nhs: date=None, al_accrual_plan: str=None, prev_employer: str=None, agencies: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'EmploymentDetails':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The EmploymentDetails of this EmploymentDetails.
        """
    ...
    def hire_details(self, hire_details):
        ...
        if hire_details is None:
            raise ValueError("Invalid value for `hire_details`, must not be `None`")
