...
class WorkingRestriction(Model):
    ...
    def __init__(self, title: str=None, validity: DateSpan=None, hours_of_work: WorkingRestrictionHoursOfWork=None, default_leave_hours: WorkingRestrictionDefaultLeaveHours=None, restrictions: WorkingRestrictionRestrictions=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'WorkingRestriction':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The WorkingRestriction of this WorkingRestriction.
        """
    ...
    def hours_of_work(self, hours_of_work):
        ...
        if hours_of_work is None:
            raise ValueError("Invalid value for `hours_of_work`, must not be `None`")
    ...
    def default_leave_hours(self, default_leave_hours):
        ...
        if default_leave_hours is None:
            raise ValueError("Invalid value for `default_leave_hours`, must not be `None`")
