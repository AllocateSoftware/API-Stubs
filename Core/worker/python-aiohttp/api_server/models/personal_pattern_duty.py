...
class PersonalPatternDuty(Model):
    ...
    def __init__(self, shift_group: str=None, shift: str=None, roster_location: str=None, team: str=None, activity_category: str=None, activity_benchmark: str=None, activity_type: str=None, activity_profile: str=None, work: str=None, start: str=None, end: str=None, monthly_reccurrance: bool=None):
