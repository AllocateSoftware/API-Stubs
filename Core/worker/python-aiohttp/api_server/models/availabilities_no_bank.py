...
class AvailabilitiesNoBank(Model):
    ...
    def __init__(self, start: str=None, number_of_occurances: float=None, notes: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'AvailabilitiesNoBank':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The Availabilities_NoBank of this AvailabilitiesNoBank.
        """
