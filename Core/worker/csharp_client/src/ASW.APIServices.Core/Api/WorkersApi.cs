...
namespace ASW.APIServices.Core.Api
{
    ...
    public partial class WorkersApi : IWorkersApi
    {
        ...
        /// <returns></returns>
        public WorkersApi(ASW.APIServices.Core.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<WorkerRegistrationResponse> RegisterWorkerWithHttpInfo (Person person)
        {
            ...
            if (person == null)
                throw new ApiException(400, "Missing required parameter 'person' when calling WorkersApi->RegisterWorker");
