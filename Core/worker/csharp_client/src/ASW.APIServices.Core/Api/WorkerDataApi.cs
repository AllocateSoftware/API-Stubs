...
namespace ASW.APIServices.Core.Api
{
    ...
    /// </summary>
    public interface IWorkerDataApi : IApiAccessor
    {
    ...
    public partial class WorkerDataApi : IWorkerDataApi
    {
        ...
        /// <returns></returns>
        public WorkerDataApi(ASW.APIServices.Core.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<WorkerRegistrationResponse> RegisterWorkerWithHttpInfo (Person person)
        {
            ...
            if (person == null)
                throw new ApiException(400, "Missing required parameter 'person' when calling WorkerDataApi->RegisterWorker");
