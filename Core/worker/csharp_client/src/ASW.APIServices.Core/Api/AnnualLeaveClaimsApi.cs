...
namespace ASW.APIServices.Core.Api
{
    ...
    /// </summary>
    public interface IAnnualLeaveClaimsApi : IApiAccessor
    {
    ...
    public partial class AnnualLeaveClaimsApi : IAnnualLeaveClaimsApi
    {
        ...
        /// <returns></returns>
        public AnnualLeaveClaimsApi(ASW.APIServices.Core.Client.Configuration configuration = null)
        {
        ...
        /// <param name="leaveClaim">Leave claim for a worker</param>
        /// <returns>ApiResponse of AsyncResponse</returns>
        public ApiResponse<AsyncResponse> SubmitAnnualLeaveClaimWithHttpInfo (string id, LeaveClaim leaveClaim)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling AnnualLeaveClaimsApi->SubmitAnnualLeaveClaim");
            // verify the required parameter 'leaveClaim' is set
            if (leaveClaim == null)
                throw new ApiException(400, "Missing required parameter 'leaveClaim' when calling AnnualLeaveClaimsApi->SubmitAnnualLeaveClaim");
        ...
        {
             ApiResponse<AsyncResponse> localVarResponse = await SubmitAnnualLeaveClaimAsyncWithHttpInfo(id, leaveClaim);
             return localVarResponse.Data;
