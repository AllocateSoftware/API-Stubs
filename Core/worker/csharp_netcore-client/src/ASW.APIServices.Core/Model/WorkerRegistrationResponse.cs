...
namespace ASW.APIServices.Core.Model
{
    ...
    public partial class WorkerRegistrationResponse :  IEquatable<WorkerRegistrationResponse>, IValidatableObject
    {
        ...
        public WorkerRegistrationResponse(string personId = default(string))
        {
            // to ensure "personId" is required (not null)
            if (personId == null)
            {
                throw new InvalidDataException("personId is a required property for WorkerRegistrationResponse and cannot be null");
            }
            else
            {
