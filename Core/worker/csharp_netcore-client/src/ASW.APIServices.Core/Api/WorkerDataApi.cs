...
namespace ASW.APIServices.Core.Api
{
    ...
    /// </summary>
    public interface IWorkerDataApiSync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IWorkerDataApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IWorkerDataApi : IWorkerDataApiSync, IWorkerDataApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class WorkerDataApi : IWorkerDataApi
    {
        private ASW.APIServices.Core.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="WorkerDataApi"/> class.
        /// </summary>
        /// <returns></returns>
        public WorkerDataApi() : this((string) null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public WorkerDataApi(String basePath)
        {
        ...
        /// <returns></returns>
        public WorkerDataApi(ASW.APIServices.Core.Client.Configuration configuration)
        {
        ...
        public WorkerDataApi(ASW.APIServices.Core.Client.ISynchronousClient client,ASW.APIServices.Core.Client.IAsynchronousClient asyncClient, ASW.APIServices.Core.Client.IReadableConfiguration configuration)
        {
        ...
        public ASW.APIServices.Core.Client.ApiResponse< WorkerRegistrationResponse > RegisterWorkerWithHttpInfo (Person person)
        {
            ...
            if (person == null)
                throw new ASW.APIServices.Core.Client.ApiException(400, "Missing required parameter 'person' when calling WorkerDataApi->RegisterWorker");
