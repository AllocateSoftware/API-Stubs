...
class Person(Model):
    ...
    def __init__(self, identification=None, personal_info=None, employment_details=None, work_locations=None, postings=None, contracts=None, skills=None, specialties=None, attributes=None, visas=None, working_restrictions=None, availabilities=None, personal_pattern=None):  # noqa: E501
