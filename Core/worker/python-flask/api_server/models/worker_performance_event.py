...
class WorkerPerformanceEvent(Model):
    ...
    def __init__(self, worker=None, duty_details=None, evaluation=None):  # noqa: E501
    ...
    def from_dict(cls, dikt) -> 'WorkerPerformanceEvent':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The WorkerPerformanceEvent of this WorkerPerformanceEvent.  # noqa: E501
        :rtype: WorkerPerformanceEvent
        """
