...
class ProposalDetails(Model):
    ...
    def __init__(self, person_id: str=None, engagement_route: str=None, agency_id: object=None, cost: float=None, cancellation_costs: List[CancellationCost]=None, options: List[List[str]]=None):
    ...
    def engagement_route(self, engagement_route):
        ...
        """
        allowed_values = ["substantive", "bank", "agency", "other"]
    ...
    def cancellation_costs(self, cancellation_costs):
        ...
        if cancellation_costs is None:
            raise ValueError("Invalid value for `cancellation_costs`, must not be `None`")
