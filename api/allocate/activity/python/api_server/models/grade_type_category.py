...
class GradeTypeCategory(object):
    ...
    @property
    def name(self):
        """Gets the name of this GradeTypeCategory.  # noqa: E501


        :return: The name of this GradeTypeCategory.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GradeTypeCategory):
            return False
