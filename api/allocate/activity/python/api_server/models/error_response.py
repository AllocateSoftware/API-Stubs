...
class ErrorResponse(object):
    ...
    def __init__(self, id=None, code=None, description=None, items=None, local_vars_configuration=None):  # noqa: E501
    ...
    def id(self):
        ...
        Optional identifier for this reponse (for matching with logging)  # noqa: E501
