...
namespace ASW.APIServices.Core.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HoursAssignmentRequirement :  IEquatable<HoursAssignmentRequirement>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HoursAssignmentRequirement" /> class.
        /// </summary>
        /// <param name="grade">grade.</param>
        /// <param name="gradeType">gradeType.</param>
        /// <param name="gradeTypeCategory">gradeTypeCategory.</param>
        public HoursAssignmentRequirement(Grade grade = default(Grade), GradeType gradeType = default(GradeType), GradeTypeCategory gradeTypeCategory = default(GradeTypeCategory))
        {
            this.Grade = grade;
        ...
        {
            return this.Equals(input as HoursAssignmentRequirement);
        }

        /// <summary>
        /// Returns true if HoursAssignmentRequirement instances are equal
        /// </summary>
        /// <param name="input">Instance of HoursAssignmentRequirement to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HoursAssignmentRequirement input)
        {
            if (input == null)
                return false;
