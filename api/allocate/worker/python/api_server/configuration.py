...
class Configuration(object):
    ...
    def __init__(self, host="http://healthsuite.allocatesoftware.com/api/v1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("api_server")
            ...
            'APIAuthorizer':
                {
                    ...
                    'value': self.get_api_key_with_prefix('AuthorizationToken')
                },
            'jwt':
                {
                    'type': 'bearer',
