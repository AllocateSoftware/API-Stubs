...
class WorkingRestrictionRestrictions(Model):
    ...
    def __init__(self, effective_from: str=None, days_per_week: str=None, max_days_per_week: str=None, max_shifts_per_week: str=None, max_consecutive_days: str=None, max_consecutive_days_requested: str=None, max_work_time_per_day: str=None, max_duration_per_shift: str=None, additional_hours_per_week: str=None, max_overtime_per_day: str=None, max_overtime_per_week: str=None, max_overtime_per_calendar_month: str=None, wtd_day_start: str=None, wtd_week_day_start: str=None, wtd_week_time_start: str=None, min_break_between_shifts: float=None, notes: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'WorkingRestrictionRestrictions':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The WorkingRestriction_restrictions of this WorkingRestrictionRestrictions.
        """
