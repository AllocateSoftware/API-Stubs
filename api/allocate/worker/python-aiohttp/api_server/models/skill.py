...
class Skill(Model):
    ...
    def __init__(self, skill_group: str=None, cluster: str=None, skill: str=None, validity: DateSpan=None, date_gained: str=None, obtained_from_reason: str=None, certificate_number: str=None, notes: str=None):
