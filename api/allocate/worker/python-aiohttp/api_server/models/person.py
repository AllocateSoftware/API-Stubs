...
class Person(Model):
    ...
    def __init__(self, ids: List[Identifier]=None, identification: Identification=None, personal_info: PersonalInfo=None, employment_details: EmploymentDetails=None, work_locations: WorkLocations=None, postings: List[Posting]=None, contracts: List[Contract]=None, skills: List[Skill]=None, specialties: List[Specialty]=None, attributes: List[Attribute]=None, visas: List[Visa]=None, working_restrictions: List[WorkingRestriction]=None, availabilities: Availabilities=None, personal_pattern: PersonalPattern=None):
