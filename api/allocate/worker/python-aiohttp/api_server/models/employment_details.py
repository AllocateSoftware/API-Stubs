...
class EmploymentDetails(Model):
    ...
    def __init__(self, employment_status: str=None, employee_type: str=None, hire_details: str=None, date_joined_nhs: str=None, al_accrual_plan: str=None, prev_employer: str=None, agencies: str=None):
