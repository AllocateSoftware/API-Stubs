...
${nuget_cmd} install src/ASW.APIServices.Core/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ASW.APIServices.Core.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ASW.APIServices.Core.dll \
-recurse:'src/ASW.APIServices.Core/*.cs' \
-doc:bin/ASW.APIServices.Core.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ASW.APIServices.Core.dll was created successfully"
fi
