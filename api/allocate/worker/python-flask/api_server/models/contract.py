...
class Contract(Model):
    ...
    def __init__(self, staff_group=None, grade=None, contract=None, payscale=None, contract_type=None, contracted_time=None, default_unavailability_hours=None, wtd_opt_out=None, salary_frequency=None, salary_amount=None):  # noqa: E501
