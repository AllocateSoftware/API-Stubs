...
class ProposalDetails(object):
    ...
    def __init__(self, person_id=None, engagement_route=None, agency_id=None, cost=None, cancellation_costs=None, local_vars_configuration=None):  # noqa: E501
        ...
        if cost is not None:
            self.cost = cost
        if cancellation_costs is not None:
