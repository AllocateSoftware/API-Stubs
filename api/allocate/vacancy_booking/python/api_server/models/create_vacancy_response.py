...
class CreateVacancyResponse(object):
    ...
    def __init__(self, vacancy_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def vacancy_id(self):
        """Gets the vacancy_id of this CreateVacancyResponse.  # noqa: E501

        The ID of the vacancy created  # noqa: E501

        :return: The vacancy_id of this CreateVacancyResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateVacancyResponse):
            return False
