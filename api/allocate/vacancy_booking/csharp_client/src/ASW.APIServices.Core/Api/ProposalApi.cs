...
namespace ASW.APIServices.Core.Api
{
    ...
    /// </summary>
    public interface IProposalApi : IApiAccessor
    {
    ...
    public partial class ProposalApi : IProposalApi
    {
        ...
        /// <returns></returns>
        public ProposalApi(ASW.APIServices.Core.Client.Configuration configuration = null)
        {
        ...
        /// <param name="id">The ID of the proposal</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> AcceptProposalWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProposalApi->AcceptProposal");

            var localVarPath = "/proposals/{id}/accept";
            ...
            {
                Exception exception = ExceptionFactory("AcceptProposal", localVarResponse);
        ...
        /// <param name="id">The ID of the proposal</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> AcceptProposalAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProposalApi->AcceptProposal");
        ...
        public ApiResponse<Object> CancelProposalWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProposalApi->CancelProposal");
        ...
        {
             ApiResponse<ProposalDetails> localVarResponse = GetProposalWithHttpInfo(id);
        ...
        /// <param name="id">The ID of the proposal</param>
        /// <returns>ApiResponse of ProposalDetails</returns>
        public ApiResponse<ProposalDetails> GetProposalWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProposalApi->GetProposal");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetProposal", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<ProposalDetails>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (ProposalDetails) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(ProposalDetails)));
        }
        ...
        {
             ApiResponse<ProposalDetails> localVarResponse = await GetProposalAsyncWithHttpInfo(id);
             return localVarResponse.Data;
        ...
        /// <param name="id">The ID of the proposal</param>
        /// <returns>Task of ApiResponse (ProposalDetails)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<ProposalDetails>> GetProposalAsyncWithHttpInfo (string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProposalApi->GetProposal");
        ...
        public ApiResponse<Object> UpdateProposalWithHttpInfo (string id, ProposalDetails proposalDetails)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new ApiException(400, "Missing required parameter 'id' when calling ProposalApi->UpdateProposal");
            // verify the required parameter 'proposalDetails' is set
            if (proposalDetails == null)
                throw new ApiException(400, "Missing required parameter 'proposalDetails' when calling ProposalApi->UpdateProposal");
