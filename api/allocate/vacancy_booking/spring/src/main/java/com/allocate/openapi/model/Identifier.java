 ...
 * Flexible identifier
 */
@ApiModel(description = "Flexible identifier")
...
public class Identifier   {
   ...
   * @return namespace
  */
  @ApiModelProperty(example = "NI", required = true, value = "Namespace for this identifier.")
  @NotNull
   ...
   * @return id
  */
  @ApiModelProperty(example = "QQ123456C", required = true, value = "")
  @NotNull
