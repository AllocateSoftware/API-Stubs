...
import com.allocate.openapi.auth.Authentication;
import com.allocate.openapi.auth.HttpBasicAuth;
import com.allocate.openapi.auth.HttpBearerAuth;
import com.allocate.openapi.auth.ApiKeyAuth;

public class ApiClient {

    private String basePath = "http://healthsuite.allocatesoftware.com/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("APIAuthorizer", new ApiKeyAuth("header", "AuthorizationToken"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://healthsuite.allocatesoftware.com/api/v1
