...
class WorkerOffer(Model):
    ...
    def __init__(self, id: str=None, booking_request_id: str=None, worker: Person=None, agency: Agency=None, qualification_status: str=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'WorkerOffer':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The WorkerOffer of this WorkerOffer.
        """
    ...
    def worker(self, worker):
        ...
        """
        if worker is None:
            raise ValueError("Invalid value for `worker`, must not be `None`")
    ...
    def qualification_status(self, qualification_status):
        ...
        """
        allowed_values = ["qualified", "unqualified"]
