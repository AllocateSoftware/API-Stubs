...
namespace ASW.APIServices.VMS.Api
{
    ...
    /// </summary>
    public interface IBookingsApi : IApiAccessor
    {
    ...
    public partial class BookingsApi : IBookingsApi
    {
        ...
        /// <returns></returns>
        public BookingsApi(ASW.APIServices.VMS.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<string> localVarResponse = AcceptAgencyOfferWithHttpInfo(bookingRequestId, offerId);
        ...
        /// <param name="offerId">ID of the offer to accept. Depending on the VMS, this may be a unique ID, an index to locate an agency, or the agency ID itself.</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse<string> AcceptAgencyOfferWithHttpInfo (string bookingRequestId, string offerId)
        {
            // verify the required parameter 'bookingRequestId' is set
            if (bookingRequestId == null)
                throw new ApiException(400, "Missing required parameter 'bookingRequestId' when calling BookingsApi->AcceptAgencyOffer");
            // verify the required parameter 'offerId' is set
            if (offerId == null)
                throw new ApiException(400, "Missing required parameter 'offerId' when calling BookingsApi->AcceptAgencyOffer");

            var localVarPath = "/bookingRequests/{bookingRequestId}/offers/{offerId}/accept";
            ...
            if (bookingRequestId != null) localVarPathParams.Add("bookingRequestId", this.Configuration.ApiClient.ParameterToString(bookingRequestId)); // path parameter
            ...
            {
                Exception exception = ExceptionFactory("AcceptAgencyOffer", localVarResponse);
        ...
        {
             ApiResponse<string> localVarResponse = await AcceptAgencyOfferAsyncWithHttpInfo(bookingRequestId, offerId);
             return localVarResponse.Data;
        ...
        /// <param name="offerId">ID of the offer to accept. Depending on the VMS, this may be a unique ID, an index to locate an agency, or the agency ID itself.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> AcceptAgencyOfferAsyncWithHttpInfo (string bookingRequestId, string offerId)
        {
            // verify the required parameter 'bookingRequestId' is set
            if (bookingRequestId == null)
                throw new ApiException(400, "Missing required parameter 'bookingRequestId' when calling BookingsApi->AcceptAgencyOffer");
        ...
        /// <param name="bookingId">ID of the booking to cancel.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> CancelBookingWithHttpInfo (string bookingId)
        {
            // verify the required parameter 'bookingId' is set
            if (bookingId == null)
                throw new ApiException(400, "Missing required parameter 'bookingId' when calling BookingsApi->CancelBooking");
        ...
        /// <param name="bookingId">ID of the booking to cancel.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> CancelBookingAsyncWithHttpInfo (string bookingId)
        {
            // verify the required parameter 'bookingId' is set
            if (bookingId == null)
                throw new ApiException(400, "Missing required parameter 'bookingId' when calling BookingsApi->CancelBooking");
        ...
        /// <param name="bookingRequestId">ID of the booking request to cancel.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> CancelBookingRequestWithHttpInfo (string bookingRequestId)
        {
            // verify the required parameter 'bookingRequestId' is set
            if (bookingRequestId == null)
                throw new ApiException(400, "Missing required parameter 'bookingRequestId' when calling BookingsApi->CancelBookingRequest");

            var localVarPath = "/bookingRequests/{bookingRequestId}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("CancelBookingRequest", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="bookingRequestId">ID of the booking request to cancel.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> CancelBookingRequestAsyncWithHttpInfo (string bookingRequestId)
        {
            // verify the required parameter 'bookingRequestId' is set
            if (bookingRequestId == null)
                throw new ApiException(400, "Missing required parameter 'bookingRequestId' when calling BookingsApi->CancelBookingRequest");
        ...
        {
             ApiResponse<DutyRequest> localVarResponse = GetBookingWithHttpInfo(bookingId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="bookingId">ID of the duty booking</param>
        /// <returns>ApiResponse of DutyRequest</returns>
        public ApiResponse<DutyRequest> GetBookingWithHttpInfo (string bookingId)
        {
            // verify the required parameter 'bookingId' is set
            if (bookingId == null)
                throw new ApiException(400, "Missing required parameter 'bookingId' when calling BookingsApi->GetBooking");
            ...
            return new ApiResponse<DutyRequest>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (DutyRequest) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(DutyRequest)));
        }
        ...
        {
             ApiResponse<DutyRequest> localVarResponse = await GetBookingAsyncWithHttpInfo(bookingId);
             return localVarResponse.Data;
        ...
        /// <param name="bookingId">ID of the duty booking</param>
        /// <returns>Task of ApiResponse (DutyRequest)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<DutyRequest>> GetBookingAsyncWithHttpInfo (string bookingId)
        {
            // verify the required parameter 'bookingId' is set
            if (bookingId == null)
                throw new ApiException(400, "Missing required parameter 'bookingId' when calling BookingsApi->GetBooking");
