...
namespace ASW.APIServices.VMS.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BookingConfirmedEvent :  IEquatable<BookingConfirmedEvent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BookingConfirmedEvent" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected BookingConfirmedEvent() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="BookingConfirmedEvent" /> class.
        /// </summary>
        ...
        public BookingConfirmedEvent(string bookingRequestId = default(string), string bookingId = default(string), string agencyId = default(string), decimal cost = default(decimal))
        {
            // to ensure "bookingRequestId" is required (not null)
            if (bookingRequestId == null)
            {
                throw new InvalidDataException("bookingRequestId is a required property for BookingConfirmedEvent and cannot be null");
            }
            else
            {
            ...
            if (bookingId == null)
            {
                throw new InvalidDataException("bookingId is a required property for BookingConfirmedEvent and cannot be null");
            }
            else
            {
            ...
            if (agencyId == null)
            {
                throw new InvalidDataException("agencyId is a required property for BookingConfirmedEvent and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BookingConfirmedEvent);
        }

        /// <summary>
        /// Returns true if BookingConfirmedEvent instances are equal
        /// </summary>
        /// <param name="input">Instance of BookingConfirmedEvent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BookingConfirmedEvent input)
        {
            if (input == null)
                return false;
