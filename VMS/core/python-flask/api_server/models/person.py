...
from api_server.models.link import Link  # noqa: E501
...
class Person(Model):
    ...
    def __init__(self, id=None, universal_id=None, first_name=None, surname=None, email=None, telephone_number=None, links=None):  # noqa: E501
