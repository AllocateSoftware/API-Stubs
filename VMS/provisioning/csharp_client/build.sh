...
${nuget_cmd} install src/ASW.APIServices.VMS/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/ASW.APIServices.VMS.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/ASW.APIServices.VMS.dll \
-recurse:'src/ASW.APIServices.VMS/*.cs' \
-doc:bin/ASW.APIServices.VMS.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/ASW.APIServices.VMS.dll was created successfully"
fi
