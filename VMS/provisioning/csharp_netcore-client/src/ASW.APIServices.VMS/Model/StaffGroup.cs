...
namespace ASW.APIServices.VMS.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StaffGroup :  IEquatable<StaffGroup>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffGroup" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        /// <param name="grades">grades.</param>
        public StaffGroup(string id = default(string), string name = default(string), List<Grade> grades = default(List<Grade>))
        {
            this.Id = id;
            this.Name = name;
            this.Grades = grades;
        ...
        {
            return this.Equals(input as StaffGroup);
        }

        /// <summary>
        /// Returns true if StaffGroup instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffGroup to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffGroup input)
        {
            if (input == null)
                return false;
