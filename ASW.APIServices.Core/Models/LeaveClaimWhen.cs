...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class LeaveClaimWhen : IEquatable<LeaveClaimWhen>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((LeaveClaimWhen)obj);
        }

        /// <summary>
        /// Returns true if LeaveClaimWhen instances are equal
        /// </summary>
        /// <param name="other">Instance of LeaveClaimWhen to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeaveClaimWhen other)
        {
        ...
        public static bool operator ==(LeaveClaimWhen left, LeaveClaimWhen right)
        {
